...
Route::delete('/estabelecimento/{estabelecimento:slug}/cardapio/{cardapio}', 'CardapioController@destroy')->name('cardapios_destroy');
Route::patch('/estabelecimento/{estabelecimento:slug}/cardapio/{cardapio}', 'CardapioController@update')->name('cardapios_update');
